...
// Мутация createNote будет вызвана в tRPC API(добавить новую запись в БД)
    ...
    return (
        <section>
            <div className="flex justify-between items-center mb-3 pb-3 border-b border-gray-200">
                <h2 className="text-2xl text-ct-dark-600 font-semibold">Создать запись</h2>
                <div
            ...
            <form className="w-full" onSubmit={handleSubmit(onSubmitHandler)}>
                ...
                <LoadingButton loading={isLoading}>Создать запись</LoadingButton>
            </form>
        </section>
    );
};
