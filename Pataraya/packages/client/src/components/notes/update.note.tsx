...
const updateNoteSchema = object({
    ...
    content: string().min(1, "Контент обязателен"),
});

type UpdateNoteInput = TypeOf<typeof updateNoteSchema>;

// тож самое, вызов мутации updateNote в API tRPC (обновить соответствующую запись БД)
    ...
    return (
        <section>
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl text-ct-dark-600 font-semibold">Обновить запись</h2>
                <div
            ...
            <form className="w-full" onSubmit={handleSubmit(onSubmitHandler)}>
                ...
                <LoadingButton loading={isLoading}>Обновить запись</LoadingButton>
            </form>
        </section>
    );
};
